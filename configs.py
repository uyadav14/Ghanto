...
class Config(object):
    API_ID = int(os.getenv("API_ID", "14122446"))
    ...
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "ghanto")
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001815410794")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Movieghantobot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "970528668"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Aryanharsh")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "1001832755339")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001832755339")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://ghantoyadav:<password>@cluster0.7eruxpg.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001976028706"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "authumesh")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    UrlShortx_API = os.getenv("UrlShortx_API", "c2d821d246c8a7ad41bc6fd0a2ebd5d81c8cb06a")
